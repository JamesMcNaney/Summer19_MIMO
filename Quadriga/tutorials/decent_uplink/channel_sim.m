...
rng(16) % set random seed: comment out this line to generate a different channel each time
...
rand_trials = 500;                           %number of attempts to randomly create angular spacing
