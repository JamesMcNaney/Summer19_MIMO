...
l.track = qd_track('linear',30,0);                      % 30 m long track facing east
l.track.initial_position = [20;0;0];                    % Start position
l.set_scenario('WINNER_UMa_C2_LOS');                    % Set propagation scenario
interpolate_positions( l.track, s.samples_per_meter );  % Set sampling intervals
